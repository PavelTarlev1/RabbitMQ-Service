...
class AuctionedCards {
    cardId;
    fromPlayer;
    creditCost;
    userIdCard;
}
exports.AuctionedCards = AuctionedCards;
class HistoryCards {
    cardId;
    wonByWhoId;
    cost;
